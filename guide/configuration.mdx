...
1. Check the [Typist GitHub Issues](https://github.com/kasimeka/balatro-typist-mod/issues)
...
3. Review the [source code](https://github.com/kasimeka/balatro-typist-mod/blob/main/mod/layout.lua) for the default layout structure