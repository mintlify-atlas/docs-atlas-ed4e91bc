...
**Behavior:**
Finds the highest-value card in hand and selects it, filling remaining slots with stone cards if available.
...
**Behavior:**
Finds the lowest-value card in hand and selects it, filling remaining slots with stone cards if available.
