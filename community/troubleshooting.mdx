...
1. **Check GitHub Issues**
   ...
   Search the [GitHub issues](https://github.com/janw4ld/balatro-typist-mod/issues) to see if others have reported the same problem.
...
3. **Report a Bug**
   ...
   - Create a detailed bug report on [GitHub](https://github.com/janw4ld/balatro-typist-mod/issues)
