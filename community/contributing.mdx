...
**Before Reporting:**
1. Check if the issue already exists in [GitHub Issues](https://github.com/kasimeka/balatro-typist-mod/issues)
...
<Info>
Check the [TODOs](https://github.com/kasimeka/balatro-typist-mod#todos) and [Future Plans](https://github.com/kasimeka/balatro-typist-mod#future-plans) sections in the README to see what's already planned.
</Info>
...
- Improving the [wiki](https://github.com/kasimeka/balatro-typist-mod/wiki)
...
1. **Fork the Repository**
   ...
   Click the "Fork" button on [GitHub](https://github.com/kasimeka/balatro-typist-mod)
...
See the [LICENSE](https://github.com/kasimeka/balatro-typist-mod/blob/main/license) file for full details.
